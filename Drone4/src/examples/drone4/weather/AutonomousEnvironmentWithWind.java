...
public class AutonomousEnvironmentWithWind extends GridApplication implements UpdateIntervalListener {
	...
	public AutonomousEnvironmentWithWind(int w, int h) {
		super(w, h);
	}
	...
	public void load() {
		...
		wind = new Wind(windDirection, 0.08);
