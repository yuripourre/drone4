...
public class BeachEnvironment extends GridApplication implements UpdateIntervalListener {
	...
	protected CameraGL personView;
	
	protected CameraGL currentCamera;
	...
	public BeachEnvironment(int w, int h) {
		super(w, h);
	}
	...
	public void load() {
		...
		personView = new CameraGL(5,1,-10);
		personView.setTarget(drone);
	...
	public void display(Graphics3D drawable) {
		...
		// Update Camera View
		drawable.updateCamera(currentCamera);
		
		drawable.setColor(SVGColor.DARK_BLUE);
		drawable.drawSphere(personView, 100);
		drawable.drawSphere(cameraGL, 100);
	...
	protected void captureCamera(Graphics3D drawable, StandardCamera camera) {
		...
		//drawable.drawCamera(personView);
