...
public class DJIMainController extends DJIObject {
	 ...
	 */
	public void setNoFlyZone(DJIPhantomNoFlyZone zone, DJIExecuteBooleanResultCallback mCallBack) {
	 ...
	 * @param mCallBack - The result callback
	 */
	public void setGohomeCmd(boolean goHome, DJIExecuteBooleanResultCallback mCallBack) {
	 ...
	 */
	public void SetSmartBatteryGohomeFlag(boolean flag, DJIExecuteBooleanResultCallback mCallBack) {
	 ...
	 * @param mCallBack - The result callback
	 */
	public void setAircraftHomeGpsLocation(double latitude, double longitude,
	 ...
	 * @param mCallBack - The result callback
	 */
	public void setGohomeAltitude(float altitude, DJIExecuteBooleanResultCallback mCallBack) {
