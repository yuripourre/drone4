...
public class DJICameraSettingsTypeDef {
	...
	public enum CameraActionWhenBreak {
		Camera_Enter_Contiuous_Shooting,
		Camera_Enter_Recording,
		Camera_Keep_Current_State;
	}

	public enum CameraAntiFlickerType {
		Camera_Anti_Flicker_50Hz,
		Camera_Anti_Flicker_60Hz,
		Camera_Anti_Flicker_Auto;
	}

	public enum CameraCaptureMode {
		Camera_Continous_Capture,
	...
	public enum CameraRecordingResolutionType {
		...
		Camera_Recording_Resolution_1920x1080_60i,
