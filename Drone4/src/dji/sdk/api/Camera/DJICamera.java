...
public class DJICamera extends DJIObject {
	 ...
	 * @param mCall
	 */
	public void setCameraActionWhenConnectionBroken(
			DJICameraSettingsTypeDef.CameraActionWhenBreak action, DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraAntiFlicker(DJICameraSettingsTypeDef.CameraAntiFlickerType antiFlickerType,
	 ...
	 * @param mCall
	 */
	public void setCameraContrast(DJICameraSettingsTypeDef.CameraContrastType contrast,
			DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraExposureCompensation(
			DJICameraSettingsTypeDef.CameraExposureCompensationType compensationType,
			DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraExposureMetering(
			DJICameraSettingsTypeDef.CameraExposureMeteringType meteringType,
			DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraISO(DJICameraSettingsTypeDef.CameraISOType isoType,
			DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraPhotoFormat(DJICameraSettingsTypeDef.CameraPhotoFormatType photoFormat,
			DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraPhotoSize(DJICameraSettingsTypeDef.CameraPhotoSizeType photoSize,
			DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraRecordingParam(
			DJICameraSettingsTypeDef.CameraRecordingResolutionType resolution,
			DJICameraSettingsTypeDef.CameraRecordingFovType fov, DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraSharpness(DJICameraSettingsTypeDef.CameraSharpnessType sharpness,
			DJIExecuteResultCallback mCall) {
	 ...
	 * @param mCall
	 */
	public void setCameraWhiteBalance(DJICameraSettingsTypeDef.CameraWhiteBalanceType whiteBalance,
			DJIExecuteResultCallback mCall) {
	 ...
	 */
	public void setDjiCameraSystemStateCallBack(
			DJICameraSystemStateCallBack mDjiCameraSystemStateCallBack) {
	 ...
	 * @param mCall
	 */
	public void setMutiPhotoCount(DJICameraSettingsTypeDef.CameraMultiShotCount count,
			DJIExecuteResultCallback mCall) {
