...
public class DJIGroundStationTask {
	...
	public void insertWaypoint(DJIGroundStationWaypoint waypoint, int index) {
		mWaypointsList.add(index, waypoint);
	}

	/**
	 * Remove all waypoints (Intentionally Uppercase to reflect DJI's API)
	 */
