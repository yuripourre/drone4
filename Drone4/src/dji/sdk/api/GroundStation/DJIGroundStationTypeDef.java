...
public class DJIGroundStationTypeDef {
	...
	public enum GroundStationCancelResult {
		GS_Cancel_Began, GS_Cancel_Gps_Not_Ready, GS_Cancel_Moto_Not_Start, GS_Cancel_Successed, GS_Cancel_Timeout, GS_Cancel_Unknown;
	}

	public enum GroundStationControlMode {
		GS_Mode_Atti, GS_Mode_Gohome, GS_Mode_Gps_Atti, GS_Mode_Gps_Cruise, GS_Mode_Landing, GS_Mode_Manual, GS_Mode_Pause_1, GS_Mode_Pause_2, GS_Mode_Single, GS_Mode_TakeOff, GS_Mode_Unknown, GS_Mode_Waypoint;
	}

	public enum GroundStationGoHomeResult {
		GS_GoHome_Began, GS_GoHome_Gps_Not_Ready, GS_GoHome_Successed, GS_GoHome_Timeout, GS_GoHome_Unknown;
	}

	public enum GroundStationGpsStatus {
		GS_GPS_Excellent, GS_GPS_Good, GS_GPS_Unknown, GS_GPS_Weak;
	}
